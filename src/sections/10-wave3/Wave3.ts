...
import vertexShader from '~/assets/shaders/wave3.vert';

export class Wave3 extends Entity {
  geometry: THREE.PlaneBufferGeometry;
  material: THREE.ShaderMaterial;
  mesh: THREE.Mesh;

  async start() {
    this.geometry = new THREE.PlaneBufferGeometry(2, 2, 50, 50);
    ...
    this.mesh.rotateY(-Math.PI * 0.25);
  }
